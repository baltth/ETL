...
if(TARGET etl-compile-if)
    target_link_libraries(etl PUBLIC etl-compile-if)
endif()
if(TARGET etl-prv-compile-if)
    target_link_libraries(etl PRIVATE etl-prv-compile-if)
endif()
