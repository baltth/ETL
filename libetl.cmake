...
if(ETL_CUSTOM_LIB_SUFFIX)
    ...
    set(ETL_INSTALL_DIR include-${ETL_CUSTOM_LIB_SUFFIX})
    message(STATUS "Using custom target name ${ETL_NAME}")
else()
    set(ETL_NAME etl)
    set(ETL_INSTALL_DIR include)
endif()

if(ETL_CUSTOM_INCLUDE_SUFFIX)
    set(ETL_INSTALL_DIR include-${ETL_CUSTOM_INCLUDE_SUFFIX})
    message(STATUS "Using custom include dir ${ETL_INSTALL_DIR}/etl for install")
else()
    set(ETL_INSTALL_DIR include)
endif()
...
install(TARGETS ${ETL_NAME})
install(DIRECTORY ${ETL_INCLUDE_DIR}/etl DESTINATION ${ETL_INSTALL_DIR})
