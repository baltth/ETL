...
TEST_CASE("Etl::UnorderedMap<> swap", "[unorderedmap][etl]") {
    ...
    using PIC = Etl::Pooled::UnorderedMap<int, int, 8>;
    using DIC = Etl::Dynamic::UnorderedMap<int, int>;
    using SNMC = Etl::Static::UnorderedMap<int, Etl::Test::NonAssignable, 4>;
    using PNMC = Etl::Pooled::UnorderedMap<int, Etl::Test::NonAssignable, 8>;
    using DNMC = Etl::Dynamic::UnorderedMap<int, Etl::Test::NonAssignable>;
    ...
    SECTION("with non-assignable type") {
        ...
        auto insert = [](Etl::UnorderedMap<int, Etl::Test::NonAssignable>& map, int v) {
            map.emplace(v, Etl::Test::NonAssignable {v});
        };
