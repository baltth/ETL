...
if(ETL_BUILD_TESTS)
    ...
    target_link_libraries(testEtl PRIVATE etl etl-if)
    target_include_directories(testEtl PRIVATE ${ETL_TESTS_DIR})
    set_target_properties(testEtl PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED ON)
endif()

if(ETL_BUILD_BENCHMARKS)
    add_executable(etlInfo ${ETL_TESTS_DIR}/info.cpp ${ETL_TEST_CMN})
    set_target_properties(etlInfo PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED ON)
    target_link_libraries(etlInfo PRIVATE etl etl-if)
